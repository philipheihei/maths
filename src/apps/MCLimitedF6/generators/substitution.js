...
const QUESTION_BANK = [
  {
    ...
    substitutionView: {
      ...
      optionChecks: [
        { label: 'A', text: '2x = 2(2) = 4', latex: '2x=2(2)=4', correct: true },
        { label: 'B', text: '2x^2 = 2(2)^2 = 8', latex: '2x^2=2(2)^2=8', correct: false },
        { label: 'C', text: 'x^2+1 = (2)^2+1 = 5', latex: 'x^2+1=(2)^2+1=5', correct: false },
        { label: 'D', text: '4x = 4(2) = 8', latex: '4x=4(2)=8', correct: false },
      ],
      answerLabel: 'A',
    },
    explanationLines: [
  ...
  },
  {
    ...
    substitutionView: {
      ...
      optionChecks: [
        { label: 'A', text: '2^n = 2^2 = 4', latex: '2^n=2^2=4', correct: false },
        { label: 'B', text: '2^(2n) = 2^(2(2)) = 16', latex: '2^{2n}=2^{2(2)}=16', correct: true },
        { label: 'C', text: '2^(2n-1) = 2^(2(2)-1) = 8', latex: '2^{2n-1}=2^{2(2)-1}=8', correct: false },
  ...
  },
  {
    ...
    substitutionView: {
      ...
      optionChecks: [
        { label: 'A', text: '(-8k)/((k+2)(5k-6)) = -16/16 = -1', latex: '\\dfrac{-8k}{(k+2)(5k-6)}=\\dfrac{-16}{16}=-1', correct: false },
        { label: 'B', text: '(-2k)/((k+2)(5k-6)) = -4/16 = -1/4', latex: '\\dfrac{-2k}{(k+2)(5k-6)}=\\dfrac{-4}{16}=-\\dfrac14', correct: false },
        { label: 'C', text: '(2k)/((k+2)(5k-6)) = 4/16 = 1/4', latex: '\\dfrac{2k}{(k+2)(5k-6)}=\\dfrac{4}{16}=\\dfrac14', correct: false },
        { label: 'D', text: '(8k)/((k+2)(5k-6)) = 16/16 = 1', latex: '\\dfrac{8k}{(k+2)(5k-6)}=\\dfrac{16}{16}=1', correct: true },
      ],
      answerLabel: 'D',
    },
    explanationLines: [
  ...
  },
  {
    ...
    substitutionView: {
      ...
      optionChecks: [
        { label: 'A', text: '3(2)^2 - 4(2)(3) + 3(3)^2 = 15', latex: '3(2)^2-4(2)(3)+3(3)^2=15', correct: false },
        { label: 'B', text: '3(2)^2 - 8(2)(3) + 3(3)^2 = -9', latex: '3(2)^2-8(2)(3)+3(3)^2=-9', correct: false },
        { label: 'C', text: '5(2)^2 - 4(2)(3) + 5(3)^2 = 41', latex: '5(2)^2-4(2)(3)+5(3)^2=41', correct: false },
        { label: 'D', text: '5(2)^2 - 8(2)(3) + 5(3)^2 = 17', latex: '5(2)^2-8(2)(3)+5(3)^2=17', correct: true },
      ],
      answerLabel: 'D',
    },
    explanationLines: [
  ...
  },
  {
    ...
    substitutionView: {
      ...
      optionChecks: [
        { label: 'A', text: '3^2x^3 = 3^2(3)^3 = 3^5', latex: '3^2x^3=3^2(3)^3=3^5', correct: false },
        { label: 'B', text: '3^4x^3 = 3^4(3)^3 = 3^7', latex: '3^4x^3=3^4(3)^3=3^7', correct: false },
        { label: 'C', text: '3^11x^13 = 3^11(3)^13 = 3^24', latex: '3^{11}x^{13}=3^{11}(3)^{13}=3^{24}', correct: true },
        { label: 'D', text: '3^14x^13 = 3^14(3)^13 = 3^27', latex: '3^{14}x^{13}=3^{14}(3)^{13}=3^{27}', correct: false },
      ],
      answerLabel: 'C',
    },
    explanationLines: [
