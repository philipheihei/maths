...
const HCFLCMNotes = ({ onBack, embedded = false }) => {
  const content = (
    <div className="space-y-8 text-slate-700">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="bg-blue-100 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm mt-1">每個代數取<strong>最小次方</strong>（所有算式都有的部分）</p>
            </div>
          </div>
          <div className="bg-indigo-100 rounded-lg p-4 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm mt-1">每個代數取<strong>最大次方</strong>（所有算式出現過的最高次方）</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-green-50 rounded-xl p-5">
        ...
        <div className="bg-white rounded-lg p-4 shadow-sm mb-4">
          ...
          <ol className="list-decimal pl-5 space-y-1 text-sm">
            ...
            <li>每個字母分一行，每行列出各算式的次方，再取最小（H.C.F.）或最大（L.C.M.）次方</li>
          </ol>
        </div>
        ...
        <div className="bg-green-50 rounded-lg p-4 mb-4 border border-green-200">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2 bg-blue-50 rounded-lg px-3 py-2">
              <span className="font-bold text-blue-700 w-5"><InlineMath math="x" /></span>
            ...
            <div className="flex items-center gap-2 bg-green-100 rounded-lg px-3 py-2">
              <span className="font-bold text-green-700 w-5"><InlineMath math="y" /></span>
            ...
            <div className="flex items-center gap-2 bg-amber-50 rounded-lg px-3 py-2">
              <span className="font-bold text-amber-700 w-5"><InlineMath math="z" /></span>
              ...
              <span className="text-slate-400">→</span>
              <span className="font-bold text-amber-700">最小次方：<InlineMath math="z^0" />（不含 <InlineMath math="z" />）</span>
            </div>
          </div>
          <p className="text-xs text-amber-700 mt-2">⚠️ <InlineMath math="8x^2y^4" /> 沒有 <InlineMath math="z" />，視作 <InlineMath math="z^0" />，故 <InlineMath math="z" /> 不出現在 H.C.F. 中</p>
        ...
        <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-200">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2 bg-blue-50 rounded-lg px-3 py-2">
              <span className="font-bold text-blue-700 w-5"><InlineMath math="m" /></span>
            ...
            <div className="flex items-center gap-2 bg-green-100 rounded-lg px-3 py-2">
              <span className="font-bold text-green-700 w-5"><InlineMath math="n" /></span>
          ...
          <p className="text-xs text-green-700 mt-2">⚠️ <InlineMath math="4m^5" /> 沒有 <InlineMath math="n" />，但 L.C.M. 取最大次方，<InlineMath math="n" /> 仍需包含</p>
      ...
      <section className="bg-purple-50 rounded-xl p-5">
        ...
        <div className="bg-purple-100 rounded-lg p-4 mb-4">
          ...
          <div className="space-y-2 text-sm mt-2">
            <div className="flex items-center gap-2 bg-blue-50 rounded-lg px-3 py-2">
              <span className="font-bold text-blue-700 w-16 text-xs"><InlineMath math="(a+3)" /></span>
            ...
            <div className="flex items-center gap-2 bg-green-100 rounded-lg px-3 py-2">
              <span className="font-bold text-green-700 w-16 text-xs"><InlineMath math="(a-3)" /></span>
              <span className="bg-red-100 text-red-600 rounded px-2 py-0.5 font-sans text-xs">沒有</span>
        ...
        <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
          ...
          <div className="space-y-2 text-sm mt-2">
            <div className="flex items-center gap-2 bg-blue-100 rounded-lg px-3 py-2">
              <span className="font-bold text-blue-700 w-16 shrink-0 text-xs"><InlineMath math="x" /></span>
            ...
            <div className="flex items-center gap-2 bg-green-100 rounded-lg px-3 py-2">
              <span className="font-bold text-green-700 w-16 shrink-0 text-xs"><InlineMath math="(x-1)" /></span>
            ...
            <div className="flex items-center gap-2 bg-amber-50 rounded-lg px-3 py-2">
              <span className="font-bold text-amber-700 w-16 shrink-0 text-xs"><InlineMath math="(x+3)" /></span>
      ...
      <section className="bg-orange-50 rounded-xl p-5">
        <h2 className="text-lg font-bold text-orange-800 mb-3">四、已知 H.C.F.、L.C.M. 及兩個算式，求第三個算式</h2>

        <div className="bg-white rounded-lg p-4 shadow-sm mb-4">
          <p className="font-semibold text-orange-700 mb-2">方法（針對每個變量分行考慮）：</p>
          <ul className="list-disc pl-5 space-y-2 text-sm">
            <li>若兩個已知算式的次方都<strong>高於</strong> H.C.F. → 第三個算式需補足 H.C.F. 的次方</li>
            <li>若兩個已知算式的次方都<strong>低於</strong> L.C.M. → 第三個算式需補足 L.C.M. 的次方</li>
          </ul>
        </div>

        <div className="bg-orange-100 rounded-lg p-4">
          <p className="font-semibold mb-3">例題 5：H.C.F. = <InlineMath math="a^2b^2c" />，L.C.M. = <InlineMath math="a^4b^5c^6" />，第一個算式 = <InlineMath math="a^4b^2c^2" />，第二個算式 = <InlineMath math="a^2b^4c^6" />，求第三個算式</p>
          <div className="space-y-2 text-sm">
            <div className="bg-blue-50 rounded-lg px-3 py-2">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="font-bold text-blue-700 w-5"><InlineMath math="a" /></span>
                ...
                <span className="text-xs text-slate-500">算式1:</span><span className="bg-blue-200 rounded px-1"><InlineMath math="a^4" /></span>
                <span className="text-xs text-slate-500">算式2:</span><span className="bg-blue-200 rounded px-1"><InlineMath math="a^2" /></span>
              </div>
              <p className="text-xs mt-1 text-blue-700">算式1有 <InlineMath math="a^4" />，算式2有 <InlineMath math="a^2" />，已涵蓋 H.C.F.（<InlineMath math="a^2" />）和 L.C.M.（<InlineMath math="a^4" />）→ 第三個算式 <InlineMath math="a" /> 次方自由（取 <InlineMath math="a^2" /> 或 <InlineMath math="a^4" /> 均可）</p>
            </div>
            <div className="bg-green-50 rounded-lg px-3 py-2">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="font-bold text-green-700 w-5"><InlineMath math="b" /></span>
                ...
                <span className="text-xs text-slate-500">算式1:</span><span className="bg-green-200 rounded px-1"><InlineMath math="b^2" /></span>
                <span className="text-xs text-slate-500">算式2:</span><span className="bg-green-200 rounded px-1"><InlineMath math="b^4" /></span>
              </div>
              <p className="text-xs mt-1 text-green-700">算式1和算式2的最大次方是 <InlineMath math="b^4" />，未達到 L.C.M. 的 <InlineMath math="b^5" /> → 第三個算式必須有 <strong><InlineMath math="b^5" /></strong></p>
            </div>
            <div className="bg-amber-50 rounded-lg px-3 py-2">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="font-bold text-amber-700 w-5"><InlineMath math="c" /></span>
                ...
                <span className="text-xs text-slate-500">算式1:</span><span className="bg-amber-200 rounded px-1"><InlineMath math="c^2" /></span>
                <span className="text-xs text-slate-500">算式2:</span><span className="bg-amber-200 rounded px-1"><InlineMath math="c^6" /></span>
              </div>
              <p className="text-xs mt-1 text-amber-700">算式1和算式2的最小次方是 <InlineMath math="c^2" />，高於 H.C.F. 的 <InlineMath math="c^1" /> → 第三個算式必須有 <strong><InlineMath math="c^1" /></strong></p>
            </div>
          </div>
          <BlockMath math="\therefore \text{第三個算式} = a^2b^5c" />
        </div>
      </section>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          {[
            ...
            <div key={name} className="bg-white rounded-lg p-3 shadow-sm flex items-center gap-3">
              <span className="text-yellow-600 font-bold text-sm w-24 shrink-0 whitespace-nowrap">{name}</span>
