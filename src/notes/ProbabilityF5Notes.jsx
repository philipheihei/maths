...
// CH15-16 排列與組合 + 概率 (F5)
// ========================================
export const ProbabilityF5Notes = ({ activeSub, onNavigate }) => {
      ...
      <div className="max-w-4xl mx-auto space-y-8 animate-fade-in text-left pb-16">
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
            <div className="bg-indigo-50 p-3 rounded-xl text-center font-bold text-indigo-800">
              男 / 女
            </div>
            <div className="bg-indigo-50 p-3 rounded-xl text-center font-bold text-indigo-800">
              成人 / 小童
            ...
            <div className="bg-indigo-50 p-3 rounded-xl text-center font-bold text-indigo-800">
              答案 <span className="text-green-600 mx-0.5">✓</span> /{" "}
              ...
              <div>
                ...
                <p className="text-green-700 font-bold flex items-center gap-2">
                  <svg
                    ...
                    className="lucide lucide-arrow-right w-4 h-4 shrink-0"
                  >
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          <h3 className="text-xl font-bold text-slate-800 mb-4 flex items-center gap-2 border-b pb-2">
            <span className="bg-purple-100 text-purple-700 w-8 h-8 rounded-full flex items-center justify-center text-lg shrink-0">
              2
            </span>
            排列與組合{" "}
            <span className="text-sm font-normal text-slate-500 ml-2 hidden sm:inline">
              (常見於 DSE 乙部 Q15/16 + 每年 MC 必出)
            </span>
          </h3>
          <div className="bg-yellow-50 p-4 sm:p-5 rounded-xl border border-yellow-200 mb-6 font-medium">
            <div className="flex items-center gap-2 text-yellow-800 font-bold mb-3 pb-2 border-b border-yellow-200 border-dashed">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-calculator text-yellow-600 w-5 h-5 shrink-0"
              >
            ...
            <div className="space-y-4 text-sm sm:text-base text-slate-700 mt-4">
              <div className="flex items-start gap-3">
                <span className="bg-yellow-200 text-yellow-800 w-6 h-6 rounded-full flex items-center justify-center font-bold shrink-0 mt-0.5">
                  例
                </span>
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 font-sans text-sm sm:text-base mt-3 mb-1">
                    ...
                    <span className="inline-flex flex-col items-center justify-end -mt-4">
                      <span className="text-[10px] sm:text-xs text-amber-600 font-bold leading-none mb-1">
                        nPr
                      </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="border-2 border-indigo-200 rounded-xl overflow-hidden shadow-sm">
              <div className="bg-indigo-100 p-3 font-bold text-indigo-800 text-lg flex items-center justify-between">
                <span>
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-arrow-right inline mx-2 w-4 h-4"
                  >
                    <path d="M5 12h14"></path>
                    <path d="m12 5 7 7-7 7"></path>
                  </svg>{" "}
              ...
              <div className="p-4 bg-white text-slate-700">
                <span className="text-indigo-600 font-bold block mb-2">
                  例子：
                </span>
                排隊、拍照、密碼...
              </div>
            ...
            <div className="border-2 border-teal-200 rounded-xl overflow-hidden shadow-sm">
              ...
              <div className="p-4 bg-white text-slate-700">
                <span className="text-teal-600 font-bold block mb-2">
                  例子：
                </span>
                選拔、分發、抽取...
              </div>
          ...
          <div className="grid gap-6">
            <div className="bg-white p-5 sm:p-6 rounded-2xl border-2 border-blue-200">
              ...
              <p className="text-slate-700 mb-4 bg-blue-50 p-3 rounded-lg text-sm sm:text-base">
                某店鋪中，有 10
                個不同的手袋可放在櫥窗上。求下列各情況中擺放手袋的方法的總數。
              </p>
              <div className="space-y-4">
                <div className="border-l-4 border-indigo-400 pl-4 py-1">
                  <p className="font-bold text-slate-800 mb-1">
                    (a) 把 3 個手袋
                    <span className="ring-2 ring-green-400 rounded-full px-1">
                      排
                    </span>
                    成一列。
                    <span className="text-blue-700 font-normal text-sm ml-2">
                      (10個抽3個，計次序)
                    </span>
                  </p>
                  <div className="text-base sm:text-lg font-serif mt-3 flex items-start text-blue-700">
                    <span className="mr-2">
                      ...
                      <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-arrow-right inline w-4 h-4 text-slate-400"
                      >
                        <path d="M5 12h14"></path>
                        <path d="m12 5 7 7-7 7"></path>
                      </svg>
            ...
            <div
              className="bg-white p-5 sm:p-6 rounded-2xl border-base shadow-sm relative overflow-hidden my-2"
              style={{ borderColor: "rgb(255, 228, 230)", borderWidth: "2px" }}
            >
              ...
              <div className="ml-4 sm:ml-8 space-y-3 mb-8">
                <div className="flex items-center gap-3">
                  <span className="text-red-600 font-bold text-xl sm:text-2xl w-6 text-center">
                    ×
                  </span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-arrow-right inline w-5 h-5 text-slate-800 shrink-0"
                  >
                    <path d="M5 12h14"></path>
                    <path d="m12 5 7 7-7 7"></path>
                  </svg>
                  <span className="text-red-600 font-bold text-lg sm:text-xl tracking-wide">
                    可以同時發生{" "}
                    <span className="text-purple-700">(兩者並存)</span>
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-red-600 font-bold text-xl sm:text-2xl w-6 text-center">
              ...
              <div className="border-t border-slate-100 pt-6">
                <p className="text-blue-900 font-bold text-lg mb-6 sm:mb-8 flex gap-2 items-center">
                  <span className="text-blue-900">舉例：</span>7 個人，3 男 4
                  女，抽獎抽兩份相同禮物
                </p>
                  ...
                  <div className="flex flex-col xl:flex-row xl:items-center gap-3 xl:gap-6">
                    ...
                    <div className="flex text-purple-700 font-bold text-base items-center">
                      <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-arrow-left inline w-5 h-5 ml-4 mr-2 shrink-0 text-purple-700"
                      >
                  ...
                  <div className="flex flex-col xl:flex-row gap-3 xl:gap-6 pt-6 border-t border-dashed border-slate-200">
                    ...
                    <div className="flex text-purple-700 font-bold text-base items-start">
                      <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-arrow-left inline w-5 h-5 ml-4 mr-3 mt-1 shrink-0 text-purple-700"
                      >
                        <path d="m12 19-7-7 7-7"></path>
                        <path d="M19 12H5"></path>
                      </svg>
                      <div className="leading-relaxed">
                        一係一個男{" "}
                        <span className="text-green-700">(1男1女)</span>
                        ，一係兩個男{" "}
                        <span className="text-green-700">(2男0女)</span> 中獎，
            ...
            <div className="bg-white p-5 sm:p-6 rounded-2xl border-2 border-teal-200">
              <h4 className="font-bold text-teal-800 text-lg mb-2">
                例題 2：組合 C
              </h4>
              <div className="text-slate-700 leading-relaxed bg-teal-50 p-3 rounded-lg mb-4 text-sm sm:text-base relative border-l-4 border-green-400">
                <div className="absolute -left-[52px] top-4 text-green-600 font-bold text-xs bg-white px-1 rounded shadow-sm border border-green-200 hidden sm:block">
                  挑選
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-arrow-right inline w-3 h-3"
                  >
                    <path d="M5 12h14"></path>
                    <path d="m12 5 7 7-7 7"></path>
                  </svg>{" "}
                ...
                出動物的組合的總數。
                <br />
                <span className="text-red-600 font-bold text-xs sm:text-sm mt-3 flex items-center gap-1">
                  💡 試想想可能情況？{" "}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-arrow-right inline w-3 h-3 transform rotate-45 ml-2 mr-1 text-slate-400"
                  >
                    <path d="M5 12h14"></path>
                    <path d="m12 5 7 7-7 7"></path>
                  </svg>{" "}
              ...
              <div className="space-y-6">
                  ...
                  <div className="text-base sm:text-lg font-serif mt-4">
                    <div className="flex items-center text-green-700 font-bold mb-2 text-sm sm:text-base">
                      ...
                      <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="lucide lucide-arrow-right inline w-4 h-4 mx-1"
                      >
                        <path d="M5 12h14"></path>
                        <path d="m12 5 7 7-7 7"></path>
                      </svg>
                    ...
                    <div className="flex items-start flex-wrap gap-2">
                      ...
                      <span className="self-start mt-2 ml-4">
                        = <span className="font-bold text-slate-800">1120</span>
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="overflow-x-auto pb-4 pt-2">
                    <div className="flex gap-1 sm:gap-2 min-w-max text-center text-sm font-serif items-start">
                      <div className="flex items-start">
                        <span className="mr-3 font-bold text-slate-700 mt-2">
                          b.
                        </span>
                        <div className="inline-flex flex-col items-center mx-2 my-1 align-top">
                          <div className="mb-0.5">
                      ...
                      <span className="self-start mt-2 ml-2 text-base sm:text-lg">
                        = <span className="font-bold text-slate-800">686</span>
                      </span>
                    </div>
                  </div>
                </div>
                <div className="border-l-4 border-teal-400 pl-4 py-1">
                  <p className="font-bold text-slate-800 mb-2">
                    ...
                    。{" "}
                    <span className="text-purple-700 text-sm font-normal">
                      ← 運用二分法：全部組合數 − 沒有白兔的組合數
                    </span>
                  </p>
                  <div className="overflow-x-auto pb-4 pt-2">
                    <div className="flex gap-2 min-w-max text-center text-sm font-serif items-start">
                      <div className="flex items-start">
                        ...
                        <div className="inline-flex flex-col items-center mx-2 my-1 align-top">
                          ...
                          <div className="text-xs font-medium text-center whitespace-nowrap text-blue-700">
                            <span className="text-blue-700">全部情況</span>
                          </div>
                          <div className="text-[10px] text-slate-500 text-center whitespace-nowrap mt-0.5">
                            <span className="text-slate-500 whitespace-normal w-32 break-words leading-tight">
                              沒限制: 總共14隻
                              <br />
                              動物選6隻
                            </span>
                      ...
                      <span className="font-bold text-slate-800 self-start mt-2">
                        −
                      </span>
                      <div className="inline-flex flex-col items-center mx-2 my-1 align-top">
                        <div className="mb-0.5">
                        ...
                        <div className="text-[10px] text-slate-500 text-center whitespace-nowrap mt-0.5">
                          <span className="text-slate-500 whitespace-normal w-40 break-words leading-tight">
                            只有0兔6倉這情況
                            <br />
                            沒有至少一隻白兔
                          </span>
                      ...
                      <span className="self-start mt-2 ml-2 text-base sm:text-lg flex flex-col items-center">
                        <span>
                          ={" "}
                          <span className="font-bold text-slate-800">2975</span>
                        </span>
                        <span className="text-green-600 font-bold text-xs mt-3 flex flex-col items-center">
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="lucide lucide-arrow-right w-3 h-3 transform -rotate-90"
                          >
                            <path d="M5 12h14"></path>
                            <path d="m12 5 7 7-7 7"></path>
                          </svg>
                ...
                <div className="border-l-4 border-teal-400 pl-4 py-1">
                  ...
                  <div className="mb-4 text-xs sm:text-sm">
                    <span className="text-slate-700">
                      d. 需<span className="bg-yellow-200">列出</span>倉鼠和兔
                      不同數量 的組合，但因逐一計算太麻煩，
                    </span>
                    <br />
                  ...
                  <div className="flex gap-2 text-sm font-serif items-start pl-6">
                    <div className="inline-flex flex-col items-center mx-2 my-1 align-top">
                      ...
                      <div className="text-xs font-medium text-center whitespace-nowrap text-purple-700">
                        <span className="text-red-600 font-bold">總數</span>
                      </div>
                    </div>
                    <span className="font-bold text-slate-800 self-start mt-2">
                      −
                    ...
                    <span className="self-start mt-2 ml-2 text-base sm:text-lg">
                      = <span className="font-bold text-slate-800">1883</span>
                    </span>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          <h3 className="text-xl font-bold text-slate-800 mb-6 flex items-center gap-2 border-b pb-3">
            <span className="bg-emerald-100 text-emerald-700 w-8 h-8 rounded-full flex items-center justify-center text-lg shrink-0">
              3
            </span>
            概率
          </h3>
          <p className="text-slate-700 mb-6 font-bold text-lg">
            ...
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-arrow-right inline mx-2 w-5 h-5 text-emerald-600"
            >
              <path d="M5 12h14"></path>
              <path d="m12 5 7 7-7 7"></path>
            </svg>{" "}
          ...
          <div className="flex flex-col items-center justify-center bg-emerald-50 p-6 rounded-2xl border-2 border-emerald-100 mb-8 mx-auto w-fit shadow-sm">
            <div className="flex items-center gap-4 text-xl sm:text-2xl">
              <span className="font-bold text-slate-800">
                概率 <span className="italic font-serif">P</span> =
              </span>
              <div className="flex flex-col items-center font-bold">
                <span className="text-blue-700 border-b-[3px] border-slate-800 px-4 pb-1 mb-1">
                  想要目標的情況
                </span>
                <span className="text-green-700 px-4 pt-1 mt-1">
                  題目原本沒限制的情況
                </span>
              </div>
            </div>
          ...
          <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 mb-10 space-y-4">
            <div className="flex items-center text-slate-700 font-bold text-lg sm:text-xl">
              <span className="mr-3 text-slate-400">−</span>一定發生的概率 ={" "}
              <span className="ml-3 font-bold text-slate-900 text-2xl">1</span>
            </div>
            <div className="flex items-center text-slate-700 font-bold text-lg sm:text-xl">
              <span className="mr-3 text-slate-400">−</span>一定不會發生的概率 ={" "}
              <span className="ml-3 font-bold text-slate-900 text-2xl">0</span>
            </div>
          ...
          <div className="bg-white p-5 sm:p-6 rounded-2xl border-2 border-emerald-200 shadow-sm">
            <h4 className="font-bold text-emerald-800 text-lg sm:text-xl mb-4">
              例題 3：概率
            </h4>
            <p className="text-slate-800 font-medium mb-6 bg-emerald-50/50 p-4 rounded-lg text-base sm:text-lg border border-emerald-100">
              <span className="font-bold mr-2 text-emerald-700"></span>子健和 6
              位朋友隨機排成一行拍照。
            </p>
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center pl-2 sm:pl-4 overflow-x-auto pb-4">
                  ...
                  <div className="grid grid-cols-[max-content_minmax(0,1fr)] items-center gap-x-4 sm:gap-x-8 text-lg sm:text-xl">
                    ...
                    <div className="flex items-center text-green-700 text-sm sm:text-base font-bold bg-green-50 px-2 py-1 rounded border border-green-200">
                        ...
                        無限制 (7人隨機排列，子健沒限制企位) 的情況
                    </div>
                  </div>
                </div>
                <div className="flex items-center text-lg sm:text-xl pl-2 sm:pl-4 mt-2">
