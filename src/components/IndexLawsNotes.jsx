      ...
      <section>
        ...
        <div className="space-y-6 ml-4">
          ...
          <div className="relative">
            ...
            <Latex math="y^{\colorbox{#fef08a}{2}} \cdot y^{\colorbox{#fef08a}{3}} = y^{\colorbox{#fef08a}{2+3}} = y^{\colorbox{#fef08a}{5}}" />
        ...
        <div className="space-y-6 ml-4">
          <div>
            ...
            <div className="space-y-6 pl-4">
              <div className="flex flex-wrap lg:flex-nowrap items-center gap-2">
                <span className="text-green-700 font-bold whitespace-nowrap">情況 1 : 上面次方較大, 次方留一上</span>
          ...
          <div className="pt-4">
            ...
            <div className="space-y-3 pl-8">
              ...
              <div className="flex items-center gap-4">
                <span className="w-8 flex justify-end font-bold">=</span>
                <Latex math="\colorbox{#fef08a}{$a$} \cdot \colorbox{#fef08a}{$a^4$} \cdot \colorbox{#bbf7d0}{$b^5$} \cdot \colorbox{#bbf7d0}{$b^6$}" />
                <span className="text-green-700 font-bold ml-2">← 分類</span>
              </div>
              <div className="flex items-center gap-4">
                <span className="w-8 flex justify-end font-bold">=</span>
                <Latex math="\colorbox{#fef08a}{$a^5$} \cdot \colorbox{#bbf7d0}{$b^{11}$}" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div className="flex flex-col ml-6 space-y-4 pt-1 relative">
            <div className="flex items-center">
              <Latex math="\frac{\colorbox{#fef08a}{$(x^{-3}y^5)^2$}}{y^2}" />
            </div>
            <div className="px-4">
            ...
            <div className="flex items-center">
              ...
              <Latex math="\frac{\colorbox{#fef08a}{$x^{-6}y^{10}$}}{y^2}" />
            </div>
            <div className="px-4">
        ...
        <div className="space-y-10">
          <div>
            ...
            <div className="space-y-4 pl-4 md:pl-8">
              <div className="flex flex-wrap lg:flex-nowrap items-center gap-2">
                ...
                <Latex math="\left(\frac{1}{4^{\colorbox{#fef08a}{222}}}\right)(12^{\colorbox{#fef08a}{444}})" />
              ...
              <div className="flex flex-wrap items-center gap-4 mt-2">
                <span className="font-bold w-4 mr-6 flex justify-end">=</span>
                <Latex math="\left(\frac{12}{2}\right)^{\colorbox{#fef08a}{444}}" />
              </div>
              <div className="flex flex-wrap items-center gap-4 mt-2">
                <span className="font-bold w-4 mr-6 flex justify-end">=</span>
                <Latex math="6^{\colorbox{#fef08a}{444}}" />
              </div>
            </div>
          </div>
          ...
          <div className="pb-4">
            ...
            <div className="space-y-4 pl-4 md:pl-8">
              <div className="flex flex-wrap md:flex-nowrap items-center gap-2">
                <span className="text-blue-900 font-bold italic w-8 mr-2">e.g.</span>
                <Latex math="\colorbox{#fef08a}{3}^{3n+9} \cdot \colorbox{#fef08a}{27}^{n-2}" />
                <span className="text-green-700 font-bold ml-2">← 適用於兩者為次方的關係 <span className="font-sans">(3³=27)</span></span>
              </div>
              <div className="flex items-center gap-2 mt-2">
                <span className="font-bold w-4 mr-6 flex justify-end">=</span>
                <Latex math="\colorbox{#fef08a}{3}^{3n+9} \cdot (\colorbox{#fef08a}{3}^3)^{n-2}" />
              </div>
